class TipAdapter {
	static baseURL = "https://travel-tips-updated.herokuapp.com/tips";
	...
	static makeNewTip(section_id, place_id, info, color) {
		return fetch("https://travel-tips-updated.herokuapp.com/tips", {
			method: "POST",
			headers: {
	...
	static EditTip(tip_id, like_count, dislike_count) {
		return fetch(`https://travel-tips-updated.herokuapp.com/tips/${tip_id}`, {
			method: "PUT",
			headers: {
				"Content-Type": "application/json",
				Accept: "application/json",
